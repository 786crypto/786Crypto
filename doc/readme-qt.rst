SevenEightSixCrypto-qt: Qt4 GUI for SevenEightSixCrypto
===============================
...
Alternatively, install Qt Creator and open the `SevenEightSixCrypto-qt.pro` file.

An executable named `SevenEightSixCrypto-qt` will be built.
...
A warning for people using the *static binary* version of SevenEightSixCrypto on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of SevenEightSixCrypto is linked against libdb5.3.
...
installed causes SevenEightSixCrypto-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
