...
const string strMessageMagic = "SevenEightSixCrypto Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("SevenEightSixCrypto-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in SevenEightSixCrypto
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // SevenEightSixCrypto: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SevenEightSixCrypto", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The Team Done It ... Captain Cool SES..CSK ";
        CTransaction txNew;
        txNew.nTime = 1527425045;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1527425045;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 730549 : 76386;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x8822c109da27adbe8426b595093d76271ad28e6ca61974dbfdd37214c818d4cb"));
