...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("SES");
    case mBTC: return QString("mSES");
    case uBTC: return QString::fromUtf8("μSES");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("SESs"));
    case mBTC: return QString(QObject::tr("Milli-SESs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-SESs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
